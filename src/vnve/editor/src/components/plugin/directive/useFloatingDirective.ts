...
// Avoid using helpers not exported in current version
import {
  focusEditor,
  useComposedRef,
  useEditorPlugin,
...
export function useFloatingDirective({
  ...
  const { api, tf, useOption, setOption, getOptions } =
    useEditorPlugin(DirectivePlugin, editor.id);
  ...
  const floating = useVirtualFloating({
    ...
    getBoundingClientRect: () => (getSelectionBoundingClientRect as any)(),
