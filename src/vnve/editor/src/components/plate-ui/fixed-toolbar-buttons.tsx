...
import { Sprite, isChild } from "@vnve/core";
...
export function FixedToolbarButtons({ editor, speak, lines, onChangeSpeak, children }) {
  ...
  const characters = useMemo(() => {
    ...
    return [
      ...
      ...activeScene.children.filter(
        (child): child is Sprite => isChild(child) && (child as Sprite).assetType === DBAssetType.Character,
      ),
    ];
  }, [activeScene]);
